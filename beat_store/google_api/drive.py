...
def get_folder_ids():
    ...
    for beat_name in dict.keys(beat_folder_id):

        if 'Mixdown' in return_directory(beat_folder_id[beat_name]):
        ...
        if 'Stems' in return_directory(beat_folder_id[beat_name]):
...
if __name__ == '__main__':
    print(fetch_beat_files('The Abyss'))
